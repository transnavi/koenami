...
export default {
 ...
 'verdict.help.description': 'The position of the five measurements along the direction that separates feminine and masculine references the most (the contrast axis). 0 is exactly halfway between the two medians, −50 is the masculine median and +50 the feminine median.',
