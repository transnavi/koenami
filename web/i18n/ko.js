...
export default {
 ...
 'page.description': '여성 목소리와 남성 목소리를 둘 다 내고 싶은 사람, 트랜스젠더, 여성 목소리나 남성 목소리를 한번 내 보고 싶은 사람을 위한 무료 목소리 훈련 도구입니다. 참고 음성을 골라 따라 하며 녹음하면 내 목소리가 같은 음향 공간에 나타나고, 목표로 하는 목소리까지의 거리가 보입니다. 실시간 측정도 지원합니다.',
 ...
 'profile.fit_title_ready': '다섯 지표를 표준화한 참고 음성과의 거리. 0이면 일치. 비교 보고서를 엽니다.',
 'verdict.heading': '목소리 판정',
 'verdict.end_male': '남성적',
 'verdict.end_center': '중간',
 'verdict.end_female': '여성적',

 'graph.aria': '목소리 비교',
 'graph.canvas_aria': '목소리 분포. 스크롤로 확대·축소, 드래그로 회전, Shift+드래그로 이동. 윤곽은 1.2초 이동 중앙값 중 중심에 가까운 80%입니다.',
 'graph.projection_variance': '주성분',
 'graph.projection_variance_title': '전체 흩어짐이 큰 방향부터 보여 줍니다(주성분 분석). 여성·남성 표시는 쓰지 않습니다.',
 'graph.projection_contrast': '남녀 차이',
 'graph.projection_contrast_title': '여성적인 목소리와 남성적인 목소리가 가장 멀어지는 방향을 가로축으로 합니다. 표시가 붙은 참고 음성으로 계산합니다.',
 'graph.auto_rotate': '자동 회전',
 'graph.auto_rotate_title': '3D 자동 회전 켜기/끄기',
 'graph.space_label': '목소리 분포',
 'graph.space_title': '다섯 지표로 계산한 주성분 공간',
 'graph.space_title_contrast': '다섯 지표로 계산. 가로축은 여성적인 목소리와 남성적인 목소리가 가장 멀어지는 방향입니다.',
 'graph.zoom_in': '확대',
 'graph.zoom_out': '축소',
 ...
 'signal.words': '단어',
 'signal.words_title': '텍스트로 옮기고 단어로 나누기',
 'signal.range_reset': '선택 구간 해제',
 'signal.range_reset_title': '선택 구간 해제 (Esc)',
 'signal.canvas_aria': '파형을 클릭하면 재생 위치가 옮겨지고, 드래그하면 구간이 선택됩니다. 좌우 화살표 키로 재생 위치를 옮깁니다. 높이 눈금을 클릭하면 Hz와 음이름이 바뀝니다.',
 ...
 'favorite.add_clip': '{name}을(를) 즐겨찾기에 추가',
 'favorite.remove_clip': '{name}을(를) 즐겨찾기에서 빼기',
 ...
 'import.jvs_hint': '공식 ZIP이나 압축을 푼 폴더를 고릅니다. 100명, 5,000개 음성을 추가할 수 있습니다.',
 'import.zip': 'ZIP 고르기',
 'import.folder': '폴더 고르기',
 'import.progress_aria': 'JVS 불러오기',
 'import.cancel': '중단',
 'import.terms': '음성 이용은 JVS 약관을 따라 주세요. 불러온 참고 음성은 이 브라우저에 저장됩니다.',
 ...
 'info.about1': '여성 목소리와 남성 목소리를 둘 다 내고 싶은 사람, 트랜스젠더, 여성 목소리나 남성 목소리를 한번 내 보고 싶은 사람을 위한 목소리 훈련 도구입니다. 참고 음성을 골라 따라 하듯 녹음하면 내 목소리가 같은 음향 공간에 나타나고, 목표로 하는 목소리에 얼마나 가까운지 알 수 있습니다. 실시간 측정에서는 목소리를 조절하면서 다가갈 방향을 잡을 수 있습니다.',
 'info.about2': '참고 음성은 일본어 외에 중국어·영어·한국어를 담고 있습니다. 무료 오픈 소스이며 녹음은 브라우저 안에 저장됩니다. 앞으로 목소리 훈련 튜토리얼, 음성학·성악·음향학·해부학 관점의 분석, 더 정확한 평가 방법을 더할 예정입니다.',
 'info.guide': '사용법 (일본어) ↗',
 ...
 'share.age_note': '나이 추정 모델(audEERING)의 참고값입니다. 일본어나 연습 중인 목소리에서 ‘몇 살로 들리는가’와 맞는지는 확인하지 않았습니다. 음성은 추정에만 쓰이고 저장되지 않습니다.',
 'share.age_value': '{age} (4초 간격 추정값 {low}~{high})',
 ...
 'share.history_note': '오래된 녹음은 판정 조건(유성 구간 등)을 기록하지 않아, 조건을 확인하지 않고 표시합니다.',
 'share.note': '링크에는 다섯 측정값만 들어 있고, 녹음은 보내지 않습니다. 판정 읽는 법은 <a href="/method.html" target="_blank" hreflang="ja">측정 방법과 출처</a>(일본어)에 있습니다.',
 ...
 'metric.f0.label': '높이',
 'metric.f0.unit': 'Hz',
 'metric.f0.description': '성대가 떨리는 빠르기입니다. 유성음의 기본 주파수(F0) 중앙값을 씁니다. 값이 클수록 높은 목소리입니다. 띠는 참고 그룹 음성의 가운데 80%를 나타냅니다.',
 'metric.f0.factors': ['성대의 긴장(후두 근육을 쓰는 법)과 성대의 질량', '후두의 높이, 숨의 양, 힘이 들어가는 정도', '문장 종류와 감정. 의문문이나 강조에서는 올라갑니다'],
 'metric.f0.caveats': ['높이만으로 성별 인상이 정해지지는 않습니다. 같은 높이라도 울림에 따라 인상이 달라집니다(<a href="https://doi.org/10.5112/jjlp.50.14" target="_blank" rel="noreferrer">Sakuraba 외 2009</a>).', '숨소리나 기계음이 들어가면 극단적인 값이 나옵니다. 마이크에서 10~20cm 떨어져 조용한 곳에서 해 보세요.'],
 'metric.delta_f.label': '울림',
 'metric.delta_f.unit': 'Hz ΔF',
 'metric.delta_f.description': '처음 네 포먼트로 구한 간격입니다. 클수록 성도가 작고 밝은 울림에 대응하는 경향이 있습니다. 모음에 따라서도 달라지므로 같은 말로 비교하면 차이가 잘 보입니다.',
 'metric.delta_f.factors': ['후두의 높이(올리면 성도가 짧아져 값이 올라갑니다)', '입 벌림, 혀 위치, 입술 모양', '모음. ‘이’와 ‘아’는 같은 사람이라도 크게 다릅니다'],
 'metric.delta_f.caveats': ['추정값입니다. 짧은 녹음이나 잡음에서는 안정되지 않고, 분석 설정에 따라서도 움직입니다.', '모음의 차이가 울림의 차이처럼 보일 수 있습니다. 같은 말, 되도록 같은 모음으로 비교해 주세요.'],
 'metric.hnr.label': '질감',
 'metric.hnr.unit': 'dB',
 'metric.hnr.description': '목소리의 주기 성분과 잡음 성분의 비(HNR)입니다. 값이 작으면 숨소리나 쉰 소리와 관계있을 수 있지만, 녹음 잡음에도 좌우됩니다. 목소리의 무게를 직접 재는 지표는 아닙니다.',
 'metric.hnr.factors': ['숨소리 섞임(성대가 닫히는 방식)', '쉰 소리, 거친 소리', '녹음 잡음. 주변 소리가 많으면 내려갑니다'],
 'metric.hnr.caveats': ['목소리의 ‘무게’나 ‘굵기’의 지표가 아닙니다.', '조용한 방에서 녹음한 참고 음성과 잡음이 있는 내 녹음을 그대로 비교하면 잡음만큼 낮게 나옵니다.'],
 'metric.balance.label': '밝기',
 'metric.balance.unit': 'dB',
 'metric.balance.description': '100~1,000 Hz에 대한 1,000~4,000 Hz 소리의 세기입니다. 클수록 고음역 성분이 많습니다. 모음, 숨의 양, 마이크 특성도 영향을 줍니다.',
 'metric.balance.factors': ['입 벌림과 혀 위치', '숨의 양과 성대가 닫히는 방식', '마이크의 위치와 특성, 브라우저의 음성 처리'],
 'metric.balance.caveats': ['장비에 크게 좌우됩니다. 녹음 조건이 다른 음성끼리는 비교하기 어려운 지표입니다.', '참고 음성과의 차이보다, 같은 장비로 녹음한 내 녹음끼리의 변화를 보는 데 알맞습니다.'],
 'metric.pitch_span.label': '억양',
 'metric.pitch_span.unit': '반음',
 'metric.pitch_span.description': '목소리 높이의 10~90 백분위 폭입니다. 여성적인 인상과 관계있는 경우도 있지만, 크다고 좋은 것은 아닙니다. 일본어의 악센트, 중국어의 성조, 문장 종류, 감정에 따라 달라집니다. 표준편차와 쉼은 보고서에서 볼 수 있습니다.',
 'metric.pitch_span.factors': ['문장 종류와 감정', '언어. 일본어의 악센트, 중국어의 성조에 따라 폭이 달라집니다', '녹음 길이. 길수록 폭이 넓어지기 쉽습니다'],
 'metric.pitch_span.caveats': ['클수록 좋은 것은 아닙니다.', '길이가 다른 녹음은 비교하기 어려우니 같은 문장이나 짧은 구로 비교해 주세요.'],
 'verdict.help.label': '목소리 판정',
 'verdict.help.description': '다섯 지표를 여성적인 목소리와 남성적인 목소리의 참고 음성이 가장 멀어지는 방향(남녀 차이 축)에 투영한 위치입니다. 0은 두 참고 그룹 중앙값의 한가운데, −25는 남성적인 참고의 중앙값, +25는 여성적인 참고의 중앙값입니다.',
 'verdict.help.factors': ['위의 다섯 지표 모두. 특히 높이와 울림의 영향이 큽니다', '참고 음성의 언어. 언어마다 참고가 다르므로 언어를 넘어 수치를 비교할 수 없습니다'],
 'verdict.help.caveats': ['듣는 사람의 평가가 아니라 음향 지표의 위치입니다. 보정은 하지 않았습니다.', '짧은 녹음이나 잡음이 많은 녹음에서는 안정되지 않습니다. 같은 문장을 몇 번 녹음해 비교해 보세요.', '어느 방향이든, 그리고 0에 가까워지는 것도 목표로 봅니다.'],
 ...
 'report.note_pitch': '참고 음성의 높이는 나보다 반음 {diff}개 {direction}. 속도를 늦춰 듣고, 무리 없는 높이로 같은 문장을 해 보세요.',
 'report.higher': '높습니다',
 'report.lower': '낮습니다',
 'report.note_resonance': '울림 추정값은 나 {own}, 참고 {ref} Hz ΔF. 같은 모음이나 짧은 말을 골라, 높이를 유지하면서 울림의 차이를 들어 보세요.',
 'report.note_intonation': '억양은 언어나 문장 내용에 따라서도 달라집니다. 같은 글을 읽고 악센트, 문장 끝, 쉼을 비교해 보세요.',
 'report.distance_caption': '참고 음성과의 음향적 차이 · 0이면 일치',
 'report.distance_note': '높이·울림·질감·밝기·억양 다섯 지표를 표준화한 거리입니다. 여성스러움이나 자연스러움의 평가는 아닙니다.',
 'report.share': '두 음성의 차이: 그림에 표시 {shown}% · 생략 {omitted}%',
 'report.share_note': '5차원 차이의 제곱을 나눈 비율입니다. 그림에서 겹쳐 보여도 생략된 방향에서는 떨어져 있을 수 있습니다.',
 ...
 'report.density': '{group} 참고 분포 안의 밀도 순위: {percentile} 백분위 (듣는 사람의 평가가 아닙니다).',
 'report.projection': '분포도는 5차원을 {dimension}차원에 투영합니다. 표시하는 분산은 {variance}%. 생략된 방향의 차이는 왼쪽 지표에서 확인할 수 있습니다.',
 ...
 'error.take_save_retry': '녹음을 저장하지 못했습니다. 음성을 다운로드한 뒤 저장 공간을 확인해 주세요.',
 ...
 'tour.start': '시작하기',
 'tour.steps': [
  { title: 'Koenami에 오신 것을 환영합니다', text: '참고 음성을 따라 하며 녹음하고, 목소리의 차이를 눈으로 확인하는 도구입니다. 주요 화면의 사용법을 1분쯤 차례로 안내합니다.\n건너뛰어도 화면 오른쪽 위의 {help}에서 언제든 다시 볼 수 있습니다.' },
  { title: '고른 참고 음성', text: '지금 고른 참고 음성을 {play}로 재생하고, {star}로 즐겨찾기에 넣을 수 있습니다.' },
  { title: '참고 음성 목록', text: '목소리 종류로 거르고 정렬해서, 다가가고 싶은 목소리를 찾습니다.' },
  { title: '녹음', text: '{mic}나 {R}로 녹음을 시작하고, 한 번 더 누르면 멈춥니다.' },
  { title: '목소리 특징', text: '높이·울림·질감·밝기·억양을 나와 참고 음성으로 비교합니다.' },
  { title: '목소리 분포', text: '참고 음성의 지도입니다. 내 목소리가 참고에 얼마나 가까운지 알 수 있습니다.' },
  { title: '파형', text: '높이의 변화나 스펙트로그램을 비교합니다. 드래그로 구간을 고를 수 있습니다.' },
 ...
 'result.description': 'Koenami로 잰 목소리 판정. 여성적·남성적·중간 참고 음성 가운데 이 목소리가 어디에 있는지.',
 'result.og_description': '여성적인 목소리와 남성적인 목소리의 참고 가운데 이 목소리가 어디에 있는지.',
 'result.share_description': '{text}. 여성적인 목소리와 남성적인 목소리의 참고 가운데 이 목소리가 어디에 있는지.',
 ...
 'result.age_note': '나이 추정 모델의 참고값. 일본어나 연습 중인 목소리에서는 검증되지 않았습니다.',
 'result.try': '내 목소리도 측정해 보기',
 'result.metrics_heading': '다섯 지표',
 'result.metrics_intro': '이 목소리의 값과 참고 화자의 가운데 80%(여성적인 목소리·남성적인 목소리)를 나란히 놓았습니다.',
 'result.col_metric': '지표',
 'result.col_this': '이 목소리',
 'result.col_female': '여성적인 참고',
 'result.col_male': '남성적인 참고',
 'result.notes_heading': '이 판정 읽는 법',
 'result.notes_p1': '수치는 참고 화자로부터 구한 ‘남녀 차이’ 방향(여성적인 목소리와 남성적인 목소리가 가장 멀어지는 방향)에 이 목소리의 다섯 지표를 투영한 위치입니다. 남성적인 참고의 중앙값과 여성적인 참고의 중앙값의 한가운데를 0으로, 남성적인 참고의 중앙값을 −25, 여성적인 참고의 중앙값을 +25로 하는 직선 눈금으로 −50~+50 범위에 표시합니다. +15 이상을 ‘여성적인 목소리’, −15 이하를 ‘남성적인 목소리’, 그 사이를 ‘중간 목소리’라고 부릅니다.',
 'result.notes_p2': '어느 방향이든 목표가 됩니다. 여성 목소리를 목표로 한다면 ＋ 방향, 남성 목소리를 목표로 한다면 − 방향, 성별 인상을 옅게 하거나 중성적인 목소리를 목표로 한다면 0에 가까워지는 것이 기준입니다.',
 'result.notes_li1': '듣는 사람이 어떻게 느끼는지를 잰 것이 아니라 다섯 음향 지표의 위치입니다. 같은 사람이라도 문장, 말투, 마이크, 주변 소리에 따라 달라집니다.',
 'result.notes_li2': '참고 음성의 분포는 일반 인구의 표준값이 아닙니다. 언어마다 참고가 다르므로 언어를 넘어 수치를 비교할 수 없습니다.',
 'result.notes_li3': '짧은 녹음이나 잡음이 많은 녹음에서는 울림과 억양 값이 안정되지 않습니다. 같은 문장을 몇 번 녹음해 비교해 보세요.',
 'result.notes_footer': '판정의 계산 방법은 <a href="/method.html" hreflang="ja">측정 방법과 출처</a>(일본어)에 있습니다. 판정 방식이 바뀌면 이 번호(<span id="result-version">v1</span>)가 바뀝니다.',
 ...
 'result.version_note': '이 링크는 판정 방식 v{from}으로 만들어졌습니다. 현재 방식(v{to})으로 다시 계산했습니다.',

 'manifest.name': 'Koenami · 여성·남성 목소리 연습 도구',
 'manifest.description': '참고 음성을 따라 하며 녹음하고, 목표로 하는 목소리까지의 거리를 보는 목소리 훈련 도구.',
