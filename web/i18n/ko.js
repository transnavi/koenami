...
export default {
 ...
 'verdict.help.description': '다섯 지표를 여성적인 목소리와 남성적인 목소리의 참고 음성이 가장 멀어지는 방향(남녀 차이 축)에 투영한 위치입니다. 0은 두 참고 그룹 중앙값의 한가운데, −50은 남성적인 참고의 중앙값, +50은 여성적인 참고의 중앙값입니다.',
 ...
 'result.notes_p1': '수치는 참고 화자로부터 구한 「남녀 차이」 방향(여성적인 목소리와 남성적인 목소리가 가장 멀어지는 방향)에 이 목소리의 다섯 지표를 투영한 위치입니다. 남성적인 참고의 중앙값과 여성적인 참고의 중앙값의 한가운데를 0으로, 남성적인 참고의 중앙값을 −50, 여성적인 참고의 중앙값을 +50으로 하는 직선 눈금으로 −100〜+100 범위에 표시합니다. +30 이상을 「여성적인 목소리」, −30 이하를 「남성적인 목소리」, 그 사이를 「중간 목소리」라고 부릅니다.',
