...
export default {
 ...
 'page.description': '여성 목소리나 남성 목소리를 익히고 싶은 사람, 트랜스젠더, 아직 없는 목소리를 한번 내 보고 싶은 사람을 위한 무료 목소리 훈련 도구입니다. 참고 음성을 골라 따라 하며 녹음하면 내 목소리가 같은 음향 공간에 나타나고, 목표로 하는 목소리까지의 거리가 보입니다. 실시간 측정도 됩니다.',
 ...
 'graph.aria': '목소리 비교',
 'graph.canvas_aria': '목소리 분포. 스크롤로 확대·축소, 드래그로 회전, Shift+드래그로 이동. 윤곽은 1.2초 이동 중앙값 가운데 중심에 가까운 80%.',
 ...
 'info.about1': '여성 목소리나 남성 목소리를 익히고 싶은 사람, 트랜스젠더, 아직 없는 목소리를 한번 내 보고 싶은 사람을 위한 목소리 훈련 도구입니다. 참고 음성을 골라 따라 하듯 녹음하면 내 목소리가 같은 음향 공간에 나타나고, 목표로 하는 목소리에 얼마나 가까운지 알 수 있습니다. 실시간 측정에서는 목소리를 조절하면서 다가갈 방향을 잡을 수 있습니다.',
 'info.about2': '참고 음성은 일본어 외에 중국어·영어·한국어를 담고 있습니다. 무료 오픈 소스이며 녹음은 브라우저 안에 저장됩니다. 앞으로 목소리 훈련 튜토리얼, 음성학·성악·음향학·해부학 관점의 분석, 듣는 사람의 느낌에 더 가까운 평가 방법을 더할 예정입니다.',
 'info.guide': '사용법 (일본어) ↗',
 ...
 'metric.f0.label': '높이',
 'metric.f0.unit': 'Hz',
 'metric.f0.description': '성대가 떨리는 빠르기입니다. 유성음의 기본 주파수(F0) 중앙값을 씁니다. 값이 클수록 높은 목소리입니다. 띠는 참고 그룹 참고 음성의 가운데 80%를 나타냅니다.',
 'metric.f0.factors': ['성대의 긴장(후두 근육을 쓰는 법)과 성대의 질량', '후두의 높이, 숨의 양, 힘주기', '문장 종류와 감정. 의문문이나 강조에서는 올라갑니다'],
 ...
 'metric.hnr.factors': ['숨 새기(성대가 닫히는 방식)', '쉰 소리, 거친 소리', '녹음 잡음. 주변 소리가 많으면 내려갑니다'],
 ...
 'report.note_pitch': '참고 음성의 높이는 나보다 {diff}반음 {direction}. 속도를 늦춰 듣고, 무리 없는 높이로 같은 문장을 해 보세요.',
 'report.higher': '높습니다',
 'report.lower': '낮습니다',
