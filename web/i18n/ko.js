...
export default {
 ...
 'info.about2': '참고 음성은 일본어 외에 중국어·영어·한국어를 담고 있습니다. 무료 오픈 소스이며 녹음은 브라우저 안에 저장됩니다.',
 'info.guide': '사용법 (일본어) ↗',
 ...
 'metric.hnr.label': '질감',
 'metric.hnr.unit': 'dB',
 'metric.hnr.description': '목소리의 주기 성분과 잡음 성분의 비(HNR)입니다. 숨소리나 쉰 소리가 있으면 낮아지지만, 녹음 잡음에도 낮아집니다. 목소리의 무게를 재는 지표는 아닙니다.',
 ...
 'metric.pitch_span.description': '목소리 높이의 10〜90 백분위 폭입니다. 여성적인 인상과 관계있을 수 있지만, 일본어의 악센트, 중국어의 성조, 문장 종류, 감정에 따라서도 달라지므로 넓을수록 좋은 것은 아닙니다. 표준편차와 쉼은 보고서에서 볼 수 있습니다.',
 ...
 'result.notes_li1': '다섯 음향 지표에서 구한 위치입니다. 듣는 사람에게 어떻게 들리는지까지는 재지 않습니다. 같은 사람이라도 문장, 말투, 마이크, 주변 소리에 따라 달라집니다.',
