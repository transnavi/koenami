...
export default {
 ...
 'metric.hnr.label': '질감',
 'metric.hnr.unit': 'dB',
 'metric.hnr.description': '목소리의 주기 성분과 잡음 성분의 비(HNR)입니다. 숨소리나 쉰 소리가 있으면 낮아지지만 녹음 잡음에도 낮아지므로, 목소리의 무게를 직접 재는 지표는 아닙니다.',
 ...
 'metric.pitch_span.description': '목소리 높이의 10〜90 백분위 폭입니다. 일본어의 악센트, 중국어의 성조, 문장 종류, 감정에 따라 달라지므로, 넓다고 더 여성적인 것은 아닙니다. 표준편차와 쉼은 보고서에서 볼 수 있습니다.',
 ...
 'result.notes_li1': '재는 것은 다섯 음향 지표의 위치이고, 듣는 사람이 어떻게 느끼는지는 별개입니다. 같은 사람이라도 문장, 말투, 마이크, 주변 소리에 따라 달라집니다.',
