...
export default {
 ...
 'page.description': '両声類を目指す方、トランスジェンダーの方、女声・男声を出してみたい方向けの無料ボイトレツール。見本の声を真似して録音すると、自分の声が空間上に映り、近づきたい声との距離が見えます。リアルタイム測定にも対応。',
 ...
 'verdict.end_male': '男性的',
 'verdict.end_center': '中間',
 'verdict.end_female': '女性的',

 'graph.aria': '声の比較',
 'graph.canvas_aria': '声の分布。スクロールで拡大縮小、ドラッグで回転、Shift＋ドラッグで移動。形は1.2秒の移動中央値のうち中心に近い80%。',
 'graph.projection_variance': '主成分',
 'graph.projection_variance_title': '全体のばらつきが大きい方向から表示します（主成分分析）。女性・男性のラベルは使いません。',
 'graph.projection_contrast': '男女差',
 'graph.projection_contrast_title': '女性的な声と男性的な声が最も離れる方向を横軸にします。ラベル付きの見本から計算します。',
 'graph.auto_rotate': '自動回転',
 'graph.auto_rotate_title': '3Dの自動回転を切り替え',
 'graph.space_label': '声の分布',
 'graph.space_title': '5つの指標から計算した主成分空間',
 'graph.space_title_contrast': '5つの指標から計算。横軸は女性的な声と男性的な声が最も離れる方向です。',
 'graph.zoom_in': '拡大',
 'graph.zoom_out': '縮小',
 ...
 'signal.canvas_aria': '波形をクリックして再生位置を移動、ドラッグして範囲を選択。左右キーで再生位置を移動。高さの目盛りをクリックするとHzと音名が切り替わります。',
 ...
 'jvs.no_match': '対応するJVS音声が見つかりませんでした。公式のZIPか、展開したフォルダーを選んでください。',
 ...
 'import.cancel': '中止',
 'import.terms': '音声の利用はJVSの規約に従ってください。読み込んだ見本は、このブラウザーに保存されます。',
 ...
 'info.about1': '両声類を目指す方、トランスジェンダーの方、女声・男声を出してみたい方のためのボイトレツールです。見本の声を選び、真似するように録音すると、自分の声が空間上に映り、近づきたい声にどれくらい近いかが分かります。リアルタイム測定では、声を調整しながら寄せていく方向をつかめます。',
 'info.about2': '見本は日本語のほか、中国語・英語・韓国語を収録しています。無料・オープンソースで公開しており、録音はブラウザーの中に保存されます。今後は、ボイトレのチュートリアルや、音声学・声楽・音響・解剖学の視点からの分析、より精度の高い評価方法を加えていく予定です。',
 'info.guide': '使い方 ↗',
 ...
 'share.age_note': '年齢の推定モデル（audEERING）の参考値です。日本語や練習中の声について「何歳に聞こえるか」との一致は確認していません。音声は推定のためだけに送信され、保存されません。',
 ...
 'share.history_note': '古い録音は判定の条件（有声区間など）を記録していないため、条件を確認せずに表示しています。',
 'share.note': 'リンクには5つの測定値だけが含まれます。録音は送信されません。判定の読み方は<a href="/method.html" target="_blank">測定方法と出典</a>にあります。',
 ...
 'metric.f0.label': '高さ',
 'metric.f0.unit': 'Hz',
 'metric.f0.description': '声帯の振動の速さです。有声音の基本周波数（F0）の中央値を使います。値が大きいほど高い声です。帯は参照グループの見本の中央80%を示します。',
 'metric.f0.factors': ['声帯の張り（喉頭の筋肉の使い方）と声帯の質量', '喉頭の高さ、息の量、力み', '文の種類と感情。疑問文や強調では上がります'],
 'metric.f0.caveats': ['高さだけでは性別の印象は決まりません。同じ高さでも響きで印象が変わります（<a href="https://doi.org/10.5112/jjlp.50.14" target="_blank" rel="noreferrer">櫻庭ほか 2009</a>）。', '息の音や機械音を拾うと極端な値になります。マイクから10〜20cm離し、静かな場所で試してください。'],
 'metric.delta_f.label': '響き',
 'metric.delta_f.unit': 'Hz ΔF',
 'metric.delta_f.description': '最初の4つのフォルマントから求めた間隔です。大きいほど、声道が小さく明るい響きに対応する傾向があります。母音でも変わるので、同じ言葉で比べると違いがわかりやすくなります。',
 'metric.delta_f.factors': ['喉頭の高さ（上げると声道が短くなり、値が上がります）', '口の開き、舌の位置、唇の形', '母音。「い」と「あ」では同じ人でも大きく違います'],
 'metric.delta_f.caveats': ['推定値です。短い録音や雑音では安定せず、解析設定でも動きます。', '母音の違いが響きの違いに見えることがあります。同じ言葉、できれば同じ母音で比べてください。'],
 'metric.hnr.label': '質感',
 'metric.hnr.unit': 'dB',
 'metric.hnr.description': '声の周期成分と雑音成分の比（HNR）です。小さい値には息やかすれが関係することがありますが、録音の雑音にも左右されます。声の重さを直接測る指標ではありません。',
 'metric.hnr.factors': ['息漏れ（声帯の閉じ方）', 'かすれ、がらつき', '録音の雑音。環境音が多いと下がります'],
 'metric.hnr.caveats': ['声の「重さ」や「太さ」の指標ではありません。', '静かな部屋で録った見本と、雑音のある自分の録音を直接比べると、雑音の分だけ低く出ます。'],
 'metric.balance.label': '明るさ',
 'metric.balance.unit': 'dB',
 'metric.balance.description': '100〜1,000 Hzに対する1,000〜4,000 Hzの音の強さです。大きいほど高域の成分が多くなります。母音、息の量、マイクの特性も影響します。',
 'metric.balance.factors': ['口の開きと舌の位置', '息の量と声帯の閉じ方', 'マイクの位置と特性、ブラウザーの音声処理'],
 'metric.balance.caveats': ['機材に強く依存します。録音条件が違う音声どうしでは比べにくい指標です。', '見本との差より、同じ機材で録った自分の録音どうしの変化を見るのに向いています。'],
 'metric.pitch_span.label': '抑揚',
 'metric.pitch_span.unit': '半音',
 'metric.pitch_span.description': '声の高さの10〜90パーセンタイルの幅です。女性的な印象に関連する場面もありますが、大きければよいとは限りません。日本語のアクセント、中国語の声調、文の種類、感情で変わります。標準偏差や間の取り方はレポートで確認できます。',
 'metric.pitch_span.factors': ['文の種類と感情', '言語。日本語のアクセント、中国語の声調で幅が変わります', '録音の長さ。長いほど幅が広がりやすくなります'],
 'metric.pitch_span.caveats': ['大きいほど良いわけではありません。', '長さの違う録音は比べにくいので、同じ文か短い句で比べてください。'],
 'verdict.help.label': '声の判定',
 'verdict.help.description': '5つの指標を、女性的な声と男性的な声の見本が最も離れる方向（男女差の軸）に投影した位置です。0は両方の見本の中央値のちょうど中間、−25は男性的な見本の中央値、+25は女性的な見本の中央値です。',
 'verdict.help.factors': ['上の5指標すべて。特に高さと響きの寄与が大きくなります', '見本の言語。言語ごとに見本が違うので、言語をまたいで数値は比べられません'],
 'verdict.help.caveats': ['聞き手の評価ではなく、音響指標の位置です。校正は行っていません。', '短い録音や雑音の多い録音では安定しません。同じ文を何度か録音して見比べてください。', 'どちらの向きも、また0に近づけることも、目標として扱います。'],
 ...
 'report.note_pitch': '見本の高さは自分より{diff}半音{direction}です。速度を落として聴き、無理のない高さで同じ文を試してください。',
 'report.higher': '高め',
 'report.lower': '低め',
 'report.note_resonance': '響きの推定値は自分 {own}、見本 {ref} Hz ΔF。同じ母音や短い言葉を選び、高さを保ちながら響きの違いを聴き比べてください。',
 'report.note_intonation': '抑揚は言語や文の内容でも変わります。同じ文章を読み、アクセント、文末、間の取り方を比べてください。',
 'report.distance_caption': '見本との音響的な差 · 0で一致',
 'report.distance_note': '高さ・響き・質感・明るさ・抑揚の5指標を標準化した距離です。女性らしさや自然さの評価には対応していません。',
 'report.share': 'この2音声の差：図に表示 {shown}% · 省略 {omitted}%',
 'report.share_note': '5次元での差の二乗を分けた割合です。図で重なっていても、省略された方向では離れていることがあります。',
 ...
 'report.density': '{group}の参照分布内の密度順位：{percentile}パーセンタイル（聞き手による評価ではありません）。',
 'report.projection': '分布図は5次元を{dimension}次元に投影しています。表示する分散は{variance}%。省略された方向の違いは左の指標で確認できます。',
 ...
 'error.take_save_retry': '録音を保存できませんでした。音声をダウンロードしてから、保存容量を確認してください。',
 ...
 'tour.start': 'はじめる',
 'tour.steps': [
  { title: 'Koenamiへようこそ', text: '見本を真似して録音し、声の違いを目で確かめられるツールです。主な画面の使い方を1分ほどで順にご紹介します。\nスキップしても、画面右上の{help}からいつでも見直せます。' },
  { title: '選んだ見本', text: '今選択されている見本を{play}で再生でき、また{star}でお気に入りとして登録できます。' },
 ...
 'result.description': 'Koenamiで測った声の判定。女性的な声・男性的な声・中間の見本の中で、この声がどこにあるか。',
 ...
 'result.metrics_intro': '自分の値と、見本の話者の中央80%（女性的な声・男性的な声）を並べています。',
 'result.col_metric': '指標',
 'result.col_this': 'この声',
 'result.col_female': '女性的な声の見本',
 'result.col_male': '男性的な声の見本',
 'result.notes_heading': 'この判定の読み方',
 'result.notes_p1': '数値は、見本の話者から求めた「男女差」の方向（女性的な声と男性的な声が最も離れる向き）に、この声の5つの指標を投影した位置です。男性的な見本の中央値と女性的な見本の中央値のちょうど中間を0とし、男性的な見本の中央値を−25、女性的な見本の中央値を+25とする直線の目盛りで、−50〜+50の範囲で表示します。+15以上を「女性的な声」、−15以下を「男性的な声」、その間を「中間的な声」と呼んでいます。',
 'result.notes_p2': 'どちらの向きも目標になります。女声を目指すなら＋の方向、男声を目指すなら−の方向、性別の印象を薄くしたい・中性的な声を目指すなら0に近づくことが目安です。',
 'result.notes_li1': '聞き手がどう感じるかを測ったものではなく、5つの音響指標の位置です。同じ人でも文章、話し方、マイク、周囲の音で変わります。',
 'result.notes_li2': '見本の分布は一般人口の標準値ではありません。言語ごとに見本が違うため、言語をまたいで数値を比べることはできません。',
 'result.notes_li3': '短い録音や雑音の多い録音では、響きや抑揚の値が安定しません。同じ文をいくつか録音して見比べてください。',
 'result.notes_footer': '判定の計算方法は<a href="/method.html">測定方法と出典</a>にあります。判定の方式を変えたときは、この番号（<span id="result-version">v1</span>）が変わります。',
 ...
 'result.version_note': 'このリンクは判定方式v{from}で作られました。現在の方式（v{to}）で計算し直しています。',
