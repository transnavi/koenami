...
export default {
 ...
 'page.description': '両声類を目指す方、トランスジェンダーの方、女声・男声を出してみたい方向けの無料ボイトレツール。見本の声を真似して録音すると、自分の声が見本と同じ地図に表示され、近づきたい声との距離が見えます。リアルタイム測定にも対応。',
 ...
 'profile.fit_title_ready': '見本との距離（5指標を標準化、0で一致）。押すと比較レポートが開きます。',
 ...
 'graph.aria': '声の比較',
 'graph.canvas_aria': '声の分布。見本の声を点で、自分の声を線で示します。スクロールで拡大縮小、ドラッグで回転、Shift＋ドラッグで移動。',
 ...
 'info.about1': '両声類を目指す方、トランスジェンダーの方、女声・男声を出してみたい方のためのボイトレツールです。見本の声を選び、真似するように録音すると、自分の声が見本と同じ地図に表示され、近づきたい声にどれくらい近いかが分かります。リアルタイム測定では、声を変えながら地図の上の位置が動くのを見て、寄せていく方向をつかめます。',
 'info.about2': '見本は日本語のほか、中国語・英語・韓国語を収録しています。無料・オープンソースで公開しており、録音はブラウザーの中に保存されます。',
 'info.guide': '使い方 ↗',
 ...
 'share.age_note': '年齢の推定モデル（audEERING）の参考値です。日本語の声や練習中の声について「何歳に聞こえるか」と合うかは確かめていません。音声は推定のためだけに送信され、保存されません。',
 ...
 'metric.delta_f.description': '最初の4つのフォルマントから求めた間隔です。大きいほど声道が短く、明るい響きになる傾向があります。母音でも変わるので、同じ言葉で比べると違いが分かりやすくなります。',
 ...
 'metric.hnr.label': '質感',
 'metric.hnr.unit': 'dB',
 'metric.hnr.description': '声の周期成分と雑音成分の比（HNR）です。息やかすれで下がりますが、録音の雑音でも下がるので、声の重さを直接測る指標ではありません。',
 ...
 'metric.pitch_span.description': '声の高さの10〜90パーセンタイルの幅です。日本語のアクセント、中国語の声調、文の種類、感情で変わるため、大きいほど女性的とは言えません。標準偏差や間の取り方はレポートで確認できます。',
 ...
 'tour.start': 'はじめる',
 'tour.steps': [
  { title: 'Koenamiへようこそ', text: '見本を真似して録音し、声の違いを目で確かめるツールです。主な画面を1分ほどで順に見ていきます。\nスキップしても、画面右上の{help}からいつでも見直せます。' },
  { title: '選んだ見本', text: '選択中の見本を{play}で再生します。{star}でお気に入りに入ります。' },
 ...
 'result.age_note': '年齢の推定モデルの参考値です。日本語や練習中の声については確かめていません。',
 'result.try': '自分の声も測る',
 ...
 'result.notes_li1': '測っているのは5つの音響指標の位置で、聞き手の印象とは別のものです。同じ人でも文章、話し方、マイク、周囲の音で変わります。',
