...
export default {
 ...
 'verdict.help.description': '5つの指標を、女性的な声と男性的な声の見本が最も離れる方向（男女差の軸）に投影した位置です。0は両方の見本の中央値のちょうど中間、−50は男性的な見本の中央値、+50は女性的な見本の中央値です。',
 ...
 'result.notes_p1': '数値は、見本の話者から求めた「男女差」の方向（女性的な声と男性的な声が最も離れる向き）に、この声の5つの指標を投影した位置です。男性的な見本の中央値と女性的な見本の中央値のちょうど中間を0とし、男性的な見本の中央値を−50、女性的な見本の中央値を+50とする直線の目盛りで、−100〜+100の範囲で表示します。+30以上を「女性的な声」、−30以下を「男性的な声」、その間を「中間的な声」と呼んでいます。',
