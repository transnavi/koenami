...
export default {
 ...
 'metric.hnr.label': '質感',
 'metric.hnr.unit': 'dB',
 'metric.hnr.description': '声の周期成分と雑音成分の比（HNR）です。息やかすれで下がりますが、録音の雑音でも下がります。声の重さを測る指標ではありません。',
 ...
 'metric.pitch_span.description': '声の高さの10〜90パーセンタイルの幅です。女性的な印象に関わることもありますが、日本語のアクセント、中国語の声調、文の種類、感情でも変わるので、広いほどよいわけではありません。標準偏差や間の取り方はレポートで確認できます。',
 ...
 'tour.steps': [
  ...
  { title: '選んだ見本', text: '{play}で選択中の見本を再生、{star}でお気に入りに追加できます。' },
 ...
 'result.age_note': '年齢の推定モデルの参考値です。日本語の声や練習中の声について「何歳に聞こえるか」と合うかは確かめていません。',
 'result.try': '自分の声も測る',
 ...
 'result.notes_li1': '5つの音響指標から求めた位置です。聞き手にどう聞こえるかまでは測っていません。同じ人でも文章、話し方、マイク、周囲の音で変わります。',
