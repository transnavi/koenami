...
function draftOf(){const item=current();return {clip:item?.clips[state.clip]?.id,ratings:state.ratings,chosen:[...state.chosen],scope:state.scope,note:$('note').value,active:state.active};}
