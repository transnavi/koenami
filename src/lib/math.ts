...
export type Axis = { label: string; unit: string; min: number; max: number; log?: boolean; ticks: number[] };
export const AXES: Record<'f0' | 'delta_f' | 'hnr' | 'balance' | 'pitch_span', Axis> = {
	...
	delta_f: { label: 'Resonance', unit: 'Hz ΔF', min: 650, max: 1500, ticks: [700, 900, 1100, 1300, 1500] },
