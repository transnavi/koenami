...
const ja = {
	...
	'page.description':
		'両声類を目指す方、トランスジェンダーの方、女声・男声を出してみたい方向けの無料ボイトレツール。見本の声を真似して録音すると、自分の声が見本と同じ分布図に表示され、近づきたい声との距離が見えます。リアルタイム測定にも対応。',
	...
	'sort.high': '高さが高い順',
	'sort.near_timbre':
		'音声モデルがとらえた声質の近さを主に、地図の5つの測定値も加えて話者ごとに並べています。各話者の中では最も近い録音が先頭です。',
	'sort.near_timbre_only':
		'音声モデルがとらえた声質の近さで話者ごとに並べています。この録音は5つの測定値が測れなかったため、地図の値は加えていません。各話者の中では最も近い録音が先頭です。',
	...
	'info.about1':
		'両声類を目指す方、トランスジェンダーの方、女声・男声を出してみたい方のためのボイトレツールです。見本の声を選び、真似するように録音すると、自分の声が見本と同じ分布図に表示され、近づきたい声にどれくらい近いかが分かります。リアルタイム測定では、声を変えながら分布図の上で位置が動くのを見て、寄せていく方向をつかめます。',
	'info.about2':
