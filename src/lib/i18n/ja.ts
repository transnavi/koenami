...
const ja = {
	...
	'profile.fit_title_ready': '見本との5指標の標準化距離。0が一致。比較レポートを開く。',
	...
	'graph.aria': '声の比較',
	'graph.canvas_aria':
		'声の分布。スクロールで拡大縮小、ドラッグで回転、Shift＋ドラッグで移動。形は1.2秒の移動中央値のうち中心に近い80%。',
	...
	'takes.sort': '並び順',
	'takes.sort_newest': '新しい順',
	'takes.sort_oldest': '古い順',
	'takes.sort_name': '名前順',
	'takes.sort_longest': '長い順',
	'live.label': 'リアルタイム',
	'live.measuring': '測定中',
	...
	'share.age_note':
		'年齢の推定モデル（audEERING）の参考値です。日本語や練習中の声について「何歳に聞こえるか」との一致は確認していません。音声は推定のためだけに送信され、保存されません。',
	...
	'result.age_note': '年齢の推定モデルの参考値。日本語や練習中の声については未検証です。',
	'result.try': '自分の声も測る',
