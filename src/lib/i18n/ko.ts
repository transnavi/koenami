...
export default {
	...
	'graph.aria': '목소리 비교',
	'graph.canvas_aria':
		'목소리 분포. 스크롤로 확대·축소, 드래그로 회전, Shift+드래그로 이동. 윤곽은 1.2초 이동 중앙값 가운데 중심에 가까운 80%.',
	...
	'info.about2':
		'참고 음성은 일본어 외에 중국어·영어·한국어를 담고 있습니다. 무료 오픈 소스이며 녹음은 브라우저 안에 저장됩니다. 앞으로 목소리 훈련 튜토리얼, 음성학·성악·음향학·해부학 관점의 분석, 듣는 사람의 느낌에 더 가까운 평가 방법을 더할 예정입니다.',
	'info.guide': '사용법 (일본어) ↗',
	...
	'metric.hnr.description':
		'목소리의 주기 성분과 잡음 성분의 비(HNR)입니다. 값이 작으면 숨소리나 쉰 소리와 관계있을 수 있지만, 녹음 잡음에도 좌우됩니다. 목소리의 무게를 직접 재는 지표는 아닙니다.',
	'metric.hnr.factors': [
		'숨 새기(성대가 닫히는 방식)',
		'쉰 소리, 거친 소리',
	...
	'metric.pitch_span.description':
		'목소리 높이의 10〜90 백분위 폭입니다. 여성적인 인상과 관계있는 경우도 있지만, 크다고 좋은 것은 아닙니다. 일본어의 악센트, 중국어의 성조, 문장 종류, 감정에 따라 달라집니다. 표준편차와 쉼은 보고서에서 볼 수 있습니다.',
	...
	'result.notes_li1':
		'듣는 사람이 어떻게 느끼는지를 잰 것이 아니라 다섯 음향 지표의 위치입니다. 같은 사람이라도 문장, 말투, 마이크, 주변 소리에 따라 달라집니다.',
	'result.notes_li2':
