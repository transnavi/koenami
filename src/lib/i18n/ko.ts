...
export default {
	...
	'page.description':
		'여성 목소리와 남성 목소리를 모두 내고 싶은 분(양성류), 트랜스젠더, 새로운 목소리를 한번 내 보고 싶은 분을 위한 무료 목소리 연습 도구입니다. 참고 음성을 골라 따라 녹음하면 내 목소리가 참고 음성과 같은 분포도에 나타나, 목표 목소리까지 얼마나 남았는지 한눈에 보입니다. 실시간 측정도 됩니다.',
	...
	'profile.fit_title_ready':
		'다섯 지표를 표준화한 참고 음성과의 거리입니다. 0이면 일치합니다. 누르면 비교 보고서가 열립니다.',
	...
	'graph.projection_variance_title':
		'전체 분포가 가장 넓게 퍼진 방향을 축으로 보여 줍니다(주성분 분석). 여성·남성 표시는 쓰지 않습니다.',
	'graph.projection_contrast': '남녀 차이',
	'graph.projection_contrast_title':
		'여성적인 목소리와 남성적인 목소리가 가장 멀리 떨어지는 방향을 가로축으로 삼습니다. 표시가 붙은 참고 음성으로 계산합니다.',
	...
	'signal.words': '단어',
	'signal.words_title': '음성 인식과 단어 나누기',
	'signal.range_reset': '선택 구간 해제',
	'signal.range_reset_title': '선택 구간 해제 (Esc)',
	'signal.canvas_aria':
		'파형을 클릭하면 재생 위치가 이동하고, 드래그하면 구간이 선택됩니다. 좌우 화살표 키로 재생 위치를 옮깁니다. 음높이 눈금을 클릭하면 Hz와 음이름이 바뀝니다.',
	...
	'jvs.cancelled': '중단했습니다. 지금까지 불러온 음성은 남아 있습니다.',
	...
	'import.jvs_hint':
		'공식 ZIP 또는 압축을 푼 폴더를 선택하세요. 100명, 5,000개 음성을 추가할 수 있습니다.',
	'import.zip': 'ZIP 고르기',
	'import.folder': '폴더 고르기',
	'import.progress_aria': 'JVS 불러오기',
	'import.cancel': '중단',
	'import.terms':
		'음성은 JVS 이용 약관에 따라 써 주세요. 불러온 참고 음성은 이 브라우저에만 저장됩니다.',
	'settings.heading': '설정',
	...
	'info.about1':
		'Koenami는 여성 목소리와 남성 목소리를 모두 내고 싶은 분(양성류), 트랜스젠더, 새로운 목소리를 한번 내 보고 싶은 분을 위한 목소리 연습 도구입니다. 참고 음성을 골라 따라 녹음하면 내 목소리가 참고 음성과 같은 분포도에 나타나, 목표 목소리에 얼마나 가까운지 한눈에 보입니다. 실시간 측정을 켜면 목소리를 바꿔 가며 분포도 위에서 내 위치가 움직이는 것을 보고, 어느 쪽으로 가야 할지 알 수 있습니다.',
	'info.about2':
	...
	'report.heading': '비교',
	'report.save': '보고서 저장',
	'metric.factors': '달라지는 요인',
	'metric.caveats': '주의',

	'share.heading': '목소리 판정',
	'share.help': '판정 읽는 법',
	'share.age_label': '들리는 나이(대략)',
	'share.age_run': '추정하기',
	'share.age_running': '추정 중…',
	'share.age_include': '이미지와 링크에 포함',
	'share.age_note':
		'나이 추정 모델(audEERING)이 낸 대략의 값입니다. 일본어 음성이나 연습 중인 목소리가 실제로 몇 살로 들리는지와 맞는지는 확인하지 않았습니다. 음성은 추정에만 쓰이고 저장되지 않습니다.',
	'share.age_value': '{age} (4초 단위 추정 {low}~{high})',
	...
	'share.history_note':
		'오래된 녹음에는 판정 조건(유성 구간 등)이 기록되어 있지 않아, 조건 확인 없이 표시합니다.',
	'share.note':
	...
	'metric.f0.description':
		'성대가 떨리는 빠르기입니다. 유성음 기본 주파수(F0)의 중앙값을 씁니다. 값이 클수록 높은 목소리입니다. 띠는 참고 그룹 화자들의 중앙 80% 범위입니다.',
	'metric.f0.factors': [
	...
	'metric.delta_f.description':
		'첫 네 포먼트로 구한 간격입니다. 클수록 성도가 짧고 울림이 밝은 편입니다. 모음에 따라서도 달라지므로 같은 말로 비교하면 차이가 잘 보입니다.',
	...
	'metric.delta_f.caveats': [
		'추정값이라 짧은 녹음이나 잡음에서는 흔들리고, 분석 설정에 따라서도 달라집니다.',
	...
	'metric.hnr.caveats': [
		...
		'조용한 방에서 녹음한 참고 음성과 잡음이 있는 내 녹음을 그대로 비교하면, 내 녹음이 잡음만큼 낮게 나옵니다.'
	],
	...
	'metric.balance.caveats': [
		...
		'참고 음성과 비교하기보다, 같은 장비로 녹음한 내 녹음끼리의 변화를 보는 데 알맞습니다.'
	],
	'metric.pitch_span.label': '억양',
	'metric.pitch_span.unit': '반음',
	'metric.pitch_span.description':
		'음높이의 10~90 백분위수 범위입니다. 여성적인 인상과 관계있을 수 있지만, 일본어 악센트, 중국어 성조, 문장 종류, 감정에 따라서도 달라지므로 넓을수록 좋은 것은 아닙니다. 표준편차와 쉬는 구간은 보고서에서 볼 수 있습니다.',
	...
	'verdict.help.description':
		'다섯 지표를, 여성적인 참고 음성과 남성적인 참고 음성이 가장 멀리 떨어지는 방향(남녀 차이 축)에 투영한 위치입니다. 0은 두 그룹 중앙값의 한가운데, −50은 남성적인 참고 음성의 중앙값, +50은 여성적인 참고 음성의 중앙값입니다.',
	'verdict.help.factors': [
		'위의 다섯 지표 모두. 특히 음높이와 울림의 영향이 큽니다',
		'참고 음성의 언어. 언어마다 참고 음성이 다르므로, 언어가 다르면 수치를 비교할 수 없습니다'
	],
	'verdict.help.caveats': [
		'듣는 사람의 평가가 아니라 음향 지표상의 위치이며, 보정하지 않았습니다.',
		'짧은 녹음이나 잡음이 많은 녹음에서는 안정되지 않습니다. 같은 문장을 몇 번 녹음해 비교해 보세요.',
		'어느 방향이든, 0에 가까워지는 것도 목표가 될 수 있습니다.'
	],
	...
	'gate.resonance_sensitivity_pct': '울림 추정 변동',
	'gate.seconds': '초',
	'gate.none': '측정 없음',
	...
	'report.note_pitch':
		'참고 음성이 내 목소리보다 {diff}반음 {direction}. 재생 속도를 늦춰 들어 보고, 무리 없는 음높이로 같은 문장을 해 보세요.',
	'report.higher': '높습니다',
	'report.lower': '낮습니다',
	...
	'report.note_intonation':
		'억양은 언어나 문장 내용에 따라서도 달라집니다. 같은 글을 읽고 악센트, 문장 끝, 쉬는 곳을 비교해 보세요.',
	'report.distance_caption': '참고 음성과의 음향적 차이 · 0이면 일치',
	'report.distance_note':
		'음높이·울림·질감·밝기·억양 다섯 지표를 표준화한 거리입니다. 여성스러움이나 자연스러움의 평가는 아닙니다.',
	...
	'report.projection':
		'분포도는 5차원을 {dimension}차원으로 투영한 것으로, 표시된 분산은 {variance}%입니다. 생략된 방향의 차이는 왼쪽 지표에서 확인할 수 있습니다.',
	...
	'tour.steps': [
		{
			...
			text: '참고 음성을 따라 녹음하고 목소리의 차이를 눈으로 확인하는 도구입니다. 주요 화면 사용법을 1분 정도 차례로 안내합니다.\n건너뛰어도 화면 오른쪽 위의 {help}에서 언제든 다시 볼 수 있습니다.'
		},
		{
			title: '고른 참고 음성',
			text: '지금 고른 참고 음성은 {play}로 재생하고, {star}로 즐겨찾기에 넣을 수 있습니다.'
		},
		{
			title: '참고 음성 목록',
			text: '목소리 종류로 추리고 정렬해서 닮고 싶은 목소리를 찾습니다.'
		},
		...
		{ title: '실시간', text: '말하면서 내 목소리의 위치가 움직이는 것을 보며 조절합니다.' },
		{ title: '자세한 설명', text: '사용법과 목소리 원리 설명은 {info}에서 열 수 있습니다.' }
	],
	...
	'result.description':
		'Koenami로 잰 목소리 판정입니다. 여성적·남성적·중간 참고 음성 가운데 이 목소리가 어디에 있는지 보여 줍니다.',
	'result.og_description':
		'여성적인 목소리와 남성적인 목소리의 참고 음성 가운데 이 목소리가 어디에 있는지.',
	'result.share_description':
		'{text}. 여성적인 목소리와 남성적인 목소리의 참고 음성 가운데 이 목소리가 어디에 있는지.',
	...
	'result.age_label': '들리는 나이(대략): ',
	'result.age_note':
		'나이 추정 모델이 낸 대략의 값입니다. 일본어 음성이나 연습 중인 목소리가 실제로 몇 살로 들리는지와 맞는지는 확인하지 않았습니다.',
	'result.try': '내 목소리도 측정해 보기',
	'result.metrics_heading': '다섯 지표',
	'result.metrics_intro':
		'이 목소리의 값을 참고 화자의 중앙 80%(여성적인 목소리·남성적인 목소리)와 나란히 놓았습니다.',
	...
	'result.notes_p1':
		'수치는 이 목소리의 다섯 지표를 참고 화자로부터 구한 ‘남녀 차이’ 방향(여성적인 목소리와 남성적인 목소리가 가장 멀리 떨어지는 방향)에 투영한 위치입니다. 남성적인 참고 음성의 중앙값과 여성적인 참고 음성의 중앙값의 한가운데가 0, 남성적인 쪽 중앙값이 −50, 여성적인 쪽 중앙값이 +50인 직선 눈금으로, −100~+100 범위에 표시합니다. +30 이상은 ‘여성적인 목소리’, −30 이하는 ‘남성적인 목소리’, 그 사이는 ‘중간적인 목소리’라고 부릅니다.',
	'result.notes_p2':
		'어느 방향이든 목표가 될 수 있습니다. 여성 목소리를 원하면 + 쪽으로, 남성 목소리를 원하면 − 쪽으로, 성별 인상을 옅게 하거나 중성적인 목소리를 원하면 0에 가까워지는 것이 기준입니다.',
	'result.notes_li1':
		'다섯 음향 지표로 구한 위치일 뿐, 듣는 사람에게 어떻게 들리는지는 재지 않습니다. 같은 사람이라도 문장, 말투, 마이크, 주변 소리에 따라 달라집니다.',
	'result.notes_li2':
	...
	'manifest.description':
		'참고 음성을 따라 녹음하고, 목표 목소리까지의 거리를 분포도에서 확인하는 목소리 연습 도구.',
