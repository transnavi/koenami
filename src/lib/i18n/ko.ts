...
export default {
	...
	'sort.high': '높은 목소리 순',
	'sort.near_timbre':
		'음성 모델이 포착한 음색의 가까움을 중심으로 지도의 다섯 가지 측정값을 더해 화자별로 정렬합니다. 각 화자 안에서는 가장 가까운 녹음이 맨 앞에 옵니다.',
	'sort.near_timbre_only':
		'음성 모델이 포착한 음색의 가까움에 따라 화자별로 정렬합니다. 이 녹음은 다섯 가지 측정값을 잴 수 없어 지도의 값은 더하지 않았습니다. 각 화자 안에서는 가장 가까운 녹음이 맨 앞에 옵니다.',
