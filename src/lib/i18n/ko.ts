...
export default {
	...
	'page.description':
		'양성류(여성·남성 목소리를 모두 내는 발성)를 목표로 하는 분, 트랜스젠더, 여성 목소리나 남성 목소리를 내 보고 싶은 분을 위한 무료 목소리 연습 도구입니다. 참고 음성을 골라 따라 하며 녹음하면 내 목소리가 같은 지도 위에 나타나고, 목표로 하는 목소리까지의 거리가 보입니다. 실시간 측정도 지원합니다.',
	...
	'import.cancel': '중단',
	'import.terms':
		'음성 이용은 JVS 이용 약관을 따라 주세요. 불러온 참고 음성은 이 브라우저에 저장됩니다.',
	'settings.heading': '설정',
	...
	'info.about1':
		'양성류(여성·남성 목소리를 모두 내는 발성)를 목표로 하는 분, 트랜스젠더, 여성 목소리나 남성 목소리를 내 보고 싶은 분을 위한 목소리 연습 도구입니다. 참고 음성을 골라 따라 하듯 녹음하면 내 목소리가 참고 음성과 같은 지도 위에 나타나고, 목표로 하는 목소리에 얼마나 가까운지 알 수 있습니다. 실시간 측정에서는 목소리를 바꿔 가며 지도 위의 위치가 움직이는 것을 보고, 어느 쪽으로 가져가야 할지 감을 잡을 수 있습니다.',
	'info.about2':
	...
	'share.age_note':
		'나이 추정 모델(audEERING)이 낸 대략의 값입니다. 일본어 음성이나 연습 중인 목소리에서 실제로 ‘몇 살로 들리는지’와 맞는지는 확인하지 않았습니다. 음성은 추정에만 쓰이고 저장되지 않습니다.',
	...
	'metric.f0.description':
		'성대가 떨리는 빠르기입니다. 유성음의 기본 주파수(F0) 중앙값을 씁니다. 값이 클수록 높은 목소리입니다. 띠는 참고 그룹 화자들의 중앙 80% 범위입니다.',
	'metric.f0.factors': [
	...
	'metric.delta_f.description':
		'첫 네 포먼트로 구한 간격입니다. 클수록 성도가 짧고 밝은 울림이 되는 경향이 있습니다. 모음에 따라서도 달라지므로 같은 말로 비교하면 차이가 잘 보입니다.',
	...
	'metric.hnr.description':
		'목소리의 주기 성분과 잡음 성분의 비(HNR)입니다. 숨소리나 쉰 소리가 있으면 낮아지고, 녹음 잡음에도 낮아집니다. 목소리의 무게를 직접 재는 지표는 아닙니다.',
	'metric.hnr.factors': [
		'숨 새는 소리(성대가 닫히는 정도)',
		'쉰 소리, 거친 소리',
	...
	'metric.pitch_span.description':
		'목소리 음높이의 10~90 백분위수 범위입니다. 여성적인 인상과 관계있을 수 있지만, 일본어의 악센트, 중국어의 성조, 문장 종류, 감정에 따라서도 달라지므로 넓을수록 좋은 것은 아닙니다. 표준편차와 쉬는 구간은 보고서에서 볼 수 있습니다.',
	...
	'verdict.help.description':
		'다섯 지표를 여성적인 목소리와 남성적인 목소리의 참고 음성이 가장 멀어지는 방향(남녀 차이 축)에 투영한 위치입니다. 0은 두 참고 그룹 중앙값의 한가운데, −50은 남성적인 참고 음성의 중앙값, +50은 여성적인 참고 음성의 중앙값입니다.',
	...
	'verdict.help.caveats': [
		...
		'어느 방향이든, 0에 가까워지는 것도 모두 목표가 될 수 있습니다.'
	],
	...
	'report.note_pitch':
		'참고 음성의 음높이는 내 목소리보다 {diff}반음 {direction}. 속도를 늦춰 듣고, 무리 없는 음높이로 같은 문장을 해 보세요.',
	'report.higher': '높습니다',
	'report.lower': '낮습니다',
	...
	'report.share_note':
		'5차원 거리의 제곱을 방향별로 나눈 비율입니다. 그림에서 겹쳐 보여도 생략된 방향에서는 떨어져 있을 수 있습니다.',
	...
	'report.projection':
		'분포도는 5차원을 {dimension}차원에 투영합니다. 표시된 분산은 {variance}%입니다. 생략된 방향의 차이는 왼쪽 지표에서 확인할 수 있습니다.',
	...
	'tour.steps': [
		{
			...
			text: '참고 음성을 따라 하며 녹음하고, 목소리의 차이를 눈으로 확인하는 도구입니다. 주요 화면 사용법을 1분 정도로 차례대로 안내합니다.\n건너뛰어도 화면 오른쪽 위의 {help}에서 언제든 다시 볼 수 있습니다.'
		},
		{
			title: '고른 참고 음성',
			text: '{play}로 지금 고른 참고 음성을 재생하고, {star}로 즐겨찾기에 넣을 수 있습니다.'
		},
		{
			title: '참고 음성 목록',
			text: '목소리 종류로 추리고 정렬해서, 다가가고 싶은 목소리를 찾습니다.'
		},
		{ title: '녹음', text: '{mic}나 {R}로 녹음을 시작하고, 한 번 더 누르면 멈춥니다.' },
		{
			title: '목소리 특징',
			text: '음높이·울림·질감·밝기·억양을 내 목소리와 참고 음성으로 비교합니다.'
		},
		{
			title: '목소리 분포',
			text: '참고 음성의 지도입니다. 내 목소리가 참고 음성에 얼마나 가까운지 알 수 있습니다.'
		},
		{
			title: '파형',
	...
	'result.age_note':
		'나이 추정 모델이 낸 대략의 값입니다. 일본어 음성이나 연습 중인 목소리에서 실제로 ‘몇 살로 들리는지’와 맞는지는 확인하지 않았습니다.',
	'result.try': '내 목소리도 재 보기',
	'result.metrics_heading': '다섯 지표',
	'result.metrics_intro':
		'이 목소리의 값과 참고 화자의 중앙 80%(여성적인 목소리·남성적인 목소리)를 나란히 놓았습니다.',
	...
	'result.notes_p1':
		'수치는 참고 화자로부터 구한 ‘남녀 차이’ 방향(여성적인 목소리와 남성적인 목소리가 가장 멀어지는 방향)에 이 목소리의 다섯 지표를 투영한 위치입니다. 남성적인 참고 음성의 중앙값과 여성적인 참고 음성의 중앙값의 한가운데를 0으로, 남성적인 참고 음성의 중앙값을 −50, 여성적인 참고 음성의 중앙값을 +50으로 하는 직선 눈금으로 −100~+100 범위에 표시합니다. +30 이상을 ‘여성적인 목소리’, −30 이하를 ‘남성적인 목소리’, 그 사이를 ‘중간적인 목소리’라고 부릅니다.',
	'result.notes_p2':
	...
	'manifest.description':
		'참고 음성을 따라 하며 녹음하고, 목표로 하는 목소리까지의 거리를 보는 목소리 연습 도구.',
