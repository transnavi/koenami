			...
			this.list.replaceChildren(
				...options.map((o) => {
					...
					if (o.dataset.peaks && wanted.includes('play')) {
						...
						wave.innerHTML =
							'<canvas></canvas><svg class="glyph" viewBox="0 0 20 20" aria-hidden="true"><path d="M7 4l9 6-9 6z"/></svg>';
						wave.onclick = () =>
							this.dispatchEvent(
