...
type: source
key: sumi-passages
title: "Example Passages (Voice Resource Project wiki)"
authors: [Sumi, Emma]
year: 2026
venue: "wiki.sumianvoice.com (Voice Resource Project; living page fetched 2026-09-17)"
url: https://wiki.sumianvoice.com/wiki/pages/various/passages.html
language: en
kind: community wiki
evidence: community
verified: page fetched 2026-09-17
topics: ["[[community-training]]", "[[voice-therapy-techniques]]", "[[english-community]]", "[[intonation]]"]
---

# Example Passages (Voice Resource Project wiki)

## What it says
- The premise: 「Here are some things to read! Getting actual conversation practice is important, but sometimes we just want a script to try things out during a practice.」 and 「You can benefit from reading any passage you like, but there are some passages that are better at helping us discover potential weakness than others.」
- Two kinds are distinguished. 「Speech-like passages are more realistic. These sound closer to something you might say when talking with a friend. They are helpful for testing intonation and other complex qualities of speech.」 Against this, 「Non-speech-like passages … are read somewhat like a script, and as such are less speechlike.」
...
- Naming a passage for nasality testing is the same move as the exercise-and-self-test structure elsewhere in the wiki ([[sumi-nasality]], [[sumi-questionable-exercises]]).
