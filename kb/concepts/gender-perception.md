---
type: concept
title: "How listeners judge voice gender"
aliases: ["listener-judgements", "listener-identity", "resynthesis", "naturalness", "性別知覚"]
---

# How listeners judge voice gender

What listeners use when they assign a gender, or a degree of masculinity/femininity, to a voice; how those judgements relate to acoustics; and how they relate to the speaker's own perception.

## What is known
- F0 explains ~42% of variance; resonance, loudness, articulation and intonation also contribute; tempo and stress do not; breathiness is mixed; risk of bias is significant [[leung2018]].
- Cue interaction: both F0 and formants are usually needed to flip perceived sex [[hillenbrand2009]]; cue ranking F0 > formants > spectral level, aperiodicity negligible [[skuk2014]]; no fixed thresholds, cue weights shift across the range [[neuhaus2026]]; formants dominate the ambiguous SFF zone in connected speech [[gelfer2013]].
- ΔF predicts perceived gender best in teacher-controlled speech, while naturalness and realness are not predictable from F0, ΔF, contact quotient or loudness [[netzorg2025]]; naturalness relates to F0, formants, loudness and speech rate in another sample [[hardy2020]].
...
## Related
[[fundamental-frequency]] · [[formants]] · [[voice-quality]] · [[nonbinary-voice]] · [[machine-gender-scoring]] · [[voice-impressions]]
