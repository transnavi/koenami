...
- **en**: [Patient-reported outcome](https://en.wikipedia.org/wiki/Patient-reported_outcome) — A patient-reported outcome (PRO) is a health outcome directly reported by the patient who experienced it.
  nl: [Patiëntgerapporteerde uitkomsten](https://nl.wikipedia.org/wiki/Patiëntgerapporteerde_uitkomsten) · ar: [استبيان النتائج المبلغة من المريض](https://ar.wikipedia.org/wiki/استبيان_النتائج_المبلغة_من_المريض) · +1 more languages
<!-- wiki:end -->
