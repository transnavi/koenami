...
export default defineConfig({
 ...
 build:{assetsInlineLimit:0,outDir:'../dist',emptyOutDir:true,rollupOptions:{input:{app:'web/index.html',method:'web/method.html',guide:'web/guide.html',tutorial:'web/tutorial.html',result:'web/result.html',review:'web/review.html'}}}
});
